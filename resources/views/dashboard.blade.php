...
<div class="dashboard">
    <div class="option">
        <a href="{{ url('/create-election') }}">
            <img src="{{ asset('images/vote-icon.png') }}" alt="Create Election">
            <button>Create Election</button>
        </a>
    </div>
    <div class="option">
        <a href="{{ url('/add-voter') }}">
            <img src="{{ asset('images/voter-icon.png') }}" alt="Add Voter">
            <button>Register Voter</button>
        </a>
    </div>
    <div class="option">
        <a href="{{ url('/add-candidate') }}">
            <img src="{{ asset('images/candidate-icon.png') }}" alt="Add Candidate">
